(ns tashikame.phase
  "Phase 0→1 staged rollout for tashikame. Per ADR-2606281500 (種をまく),
  ...
  lifts). The phase only decides whether a governor-clean verdict is PUBLISHED
  or SHADOW-RECORDED; it can only ever withhold publication, never force it.

    Phase 0  observe            — governor-clean verdicts recorded to the ledger
                                   but NOT published (shadow / observe).
    Phase 1  autonomous-publish — governor-clean verdicts publish autonomously
                                   (DEFAULT — 種をまく).")
